...
import { CheckCircle2, Shield, BookOpen, ClipboardCheck, BarChart2, FileText, Users, Briefcase, Rocket, Building2 as Building2Icon, LandPlot } from "lucide-react";
...
const whyChoose = [
  ...
  { icon: BookOpen, title: "Multi-Entity Expertise", desc: "Experienced with LLC, S Corp, and C Corp structures" },
  { icon: ClipboardCheck, title: "Compliance Focused", desc: "Ensuring your business meets all tax obligations" },
  { icon: BarChart2, title: "Financial Clarity", desc: "Accurate reporting for informed business decisions" },
];

const whoBenefits = [
  { label: "LLC Owners", icon: FileText, desc: "Pass-through tax filing and compliance for LLCs" },
  { label: "S Corp Shareholders", icon: Users, desc: "Payroll, distributions, and S Corp tax reporting" },
  { label: "C Corp Executives", icon: Briefcase, desc: "Corporate tax returns, planning, and compliance" },
  { label: "Growing Companies", icon: Rocket, desc: "Scalable corporate accounting as you expand" },
  { label: "Multi-Entity Businesses", icon: Building2Icon, desc: "Consolidated reporting across multiple entities" },
  { label: "Established Corporations", icon: LandPlot, desc: "Advanced tax strategy and multi-state compliance" },
];
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-5 gap-12 items-center">
            <ScrollReveal direction="left" className="lg:col-span-3">
              ...
              <div className="mt-6">
                <h3 className="font-heading text-sm font-semibold tracking-widest uppercase text-dark mb-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {entityTypes.map((type) => (
                    <span
                      key={type}
                      className="inline-block px-4 py-1.5 rounded-full bg-navy-500/10 border border-navy-200/40 text-sm font-semibold text-navy-700"
                    >
                      {type}
                    </span>
                  ))}
