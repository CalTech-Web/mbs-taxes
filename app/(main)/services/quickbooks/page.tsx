...
import { CheckCircle2, Shield, BookOpen, Wrench, FileCheck, BriefcaseBusiness, UserRound, Monitor, FolderOpen, ClipboardList, LandPlot } from "lucide-react";
...
const whoBenefits = [
  { label: "Small Business Owners", icon: BriefcaseBusiness, desc: "QuickBooks management and tax filing support" },
  { label: "Self-Employed Professionals", icon: UserRound, desc: "Simplified bookkeeping and expense tracking" },
  { label: "Startups Needing Setup", icon: Monitor, desc: "QuickBooks configuration and onboarding" },
  { label: "Businesses with Messy Books", icon: FolderOpen, desc: "Book cleanup, reconciliation, and organization" },
  { label: "W2 & 1099 Preparation", icon: ClipboardList, desc: "Year-end payroll forms and contractor reporting" },
  { label: "Established Businesses", icon: LandPlot, desc: "Ongoing QuickBooks maintenance and tax compliance" },
];
